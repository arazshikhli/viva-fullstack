...
export const Cobe=()=>{
    ...
    const  pointerInteracting = useRef(null), pointerInteractionMovement = useRef(0), [{r}, api] = useSpring(() => (
        {
            r: 0,
            config: {
                mass: 1,
    ...
    return <div style={{ width: '100%', maxWidth: 600, aspectRatio: 1, margin: 'auto', position: 'relative', }}>
        <canvas
            ref={canvasRef}
            onPointerDown={(e) => {
